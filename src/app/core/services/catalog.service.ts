...
export class CatalogService {
  ...
  private readonly _packages: TestPackage[] = [
    { id: 'p1', name: 'Panel 1 (pediatryczny)', slug: 'panel-1-pediatryczny', description: 'Podstawowy panel dla dzieci: najczęstsze pasożyty oraz posiew w kierunku Candida albicans.', price: 215, categoryId: 'pasozyty', testCodes: ['ASC', 'ENT', 'LAM', 'CANA'], forWhom: 'Dla dzieci — podstawowy przegląd pasożytniczy.' },
    { id: 'p4', name: 'Panel 2', slug: 'panel-2', description: 'Szeroki przegląd pasożytów jelitowych wraz z oceną pH kału i resztek pokarmowych.', price: 200, categoryId: 'pasozyty', testCodes: ['PH', 'LAM', 'ASC', 'ENT', 'TAE', 'FAS', 'STR', 'TOXC', 'TOXT', 'TRI'], forWhom: 'Przy podejrzeniu zakażenia pasożytniczego i zaburzeń trawienia.' },
    { id: 'p6', name: 'Panel 3', slug: 'panel-3', description: 'Pełna diagnostyka pasożytnicza z posiewem w kierunku Candida spp. i pleśni.', price: 395, categoryId: 'pasozyty', testCodes: ['PH', 'LAM', 'ASC', 'ENT', 'TAE', 'FAS', 'STR', 'TOXC', 'TOXT', 'TRI', 'CANS', 'POSP'], badge: 'Bestseller', forWhom: 'Gdy potrzebna jest szersza diagnostyka pasożytów i grzybów.' },
